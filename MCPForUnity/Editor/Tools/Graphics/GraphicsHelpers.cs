...
namespace MCPForUnity.Editor.Tools.Graphics
{
    internal static class GraphicsHelpers
    {
        ...
        {
            switch (RenderPipelineUtility.GetActivePipeline()) { case RenderPipelineUtility.PipelineKind.Universal: return "Universal (URP)"; case RenderPipelineUtility.PipelineKind.HighDefinition: return "High Definition (HDRP)"; case RenderPipelineUtility.PipelineKind.BuiltIn: return "Built-in"; case RenderPipelineUtility.PipelineKind.Custom: return "Custom"; default: return "Unknown"; }
        }
        ...
        internal static object ReadSerializedValue(SerializedProperty prop)
        {
            switch (prop.propertyType)
            {
                ...
                case SerializedPropertyType.Enum:
                    return prop.enumValueIndex < prop.enumNames.Length ? prop.enumNames[prop.enumValueIndex] : (object)prop.enumValueIndex;
